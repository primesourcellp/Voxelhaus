...
const whyReachOut = [
  {
    ...
    description:
      "We’re approachable, easy to talk to, and genuinely interested in your project.",
  },
  {
    icon: FaClock,
    title: "Quick Responses",
    description: "We respect your time and aim to respond as fast as possible.",
  },
  {
    icon: FaLock,
    title: "Confidential Services",
    description: "Your project details are safe and secure with us.",
  },
  {
    icon: FaLightbulb,
    title: "Tailored Advice",
    description:
      "Every project is unique, and we’ll guide you with solutions that fit your needs.",
  },
];
...
const Contact = () => {
  ...
  const settings = {
    ...
    infinite: true,
    autoplay: true,
    autoplaySpeed: 3000, // auto-scroll every 3s
    speed: 800,
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
  ...
  return (
    <div className="min-h-screen text-white pt-20 relative">
      ...
      <div className="relative z-10 pt-20 px-2 md:px-6">
        {/* Contact Header */}
        <section className="text-center py-16 px-2 md:px-6">
          <motion.h1
          ...
          >
            Let’s Connect! We’d love to hear from you. Our team provides quick,
            confidential, and professional support for your real estate
            projects.
          </motion.p>
        </section>

        {/* Contact Info + Form */}
        <section className="px-2 md:px-6 mb-20">
              ...
              {contactInfo.map((item, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group flex items-center gap-4 bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 cursor-pointer overflow-hidden w-full"
                    whileHover={{
                      scale: 1.03,
                      boxShadow: "0 10px 20px rgba(0,240,255,0.4)",
                    }}
                  >
                    {/* Icon animation */}
                    <motion.div
        ...
        <section className="py-24 px-2 md:px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              We provide dedicated, professional, and friendly service for all
              your real estate visualization needs.
            </p>
          </motion.div>
              ...
              return (
                <div key={index} className="px-6">
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                    className="flex flex-col items-center justify-center text-center bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-10"
                  >
                    <div className="w-20 h-20 bg-gradient-to-r from-[#00F0FF] to-[#0099FF] rounded-2xl flex items-center justify-center mb-6">
