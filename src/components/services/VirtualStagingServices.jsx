            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  "Advanced technology and software for superior 3D rendering quality",
                  "Comprehensive service suite from concept to final delivery",
                  "Global reach serving clients worldwide with consistent quality standards"
                ].map((item, index) => (
                  <motion.div
                    key={index}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  "Customizable staging options to match any property style",
                  "Advanced digital techniques for realistic furniture placement",
                  "Proven track record of increasing property sales and engagement"
                ].map((item, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, scale: 0.8 }}
