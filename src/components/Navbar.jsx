              ...
              >
                <Link to="/" className="flex items-center group">
                  <div className="relative">
                    <div className="w-32 h-32 rounded-xl overflow-hidden transition-all duration-300 group-hover:shadow-2xl">
                      <img 
                        src={logoImage} 
                        alt="Voxelhaus Logo" 
          ...
          <div className="px-2 py-0">
            <div className="flex items-center justify-between">
              ...
              >
                <Link to="/" className="flex items-center group">
                  <div className="relative">
                    <div className="w-28 h-20 rounded-xl overflow-hidden transition-all duration-300 group-hover:shadow-2xl">
                      <img 
                        src={logoImage} 
                        alt="Voxelhaus Logo" 
                        className="w-full h-full object-contain"
